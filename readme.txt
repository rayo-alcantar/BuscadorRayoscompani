...
Explicación técnica:
Cuando ejecute el programa,   le   dará la bienvenida con una voz sapi, Indicando los atajos principales, que son salir del programa y abrir este documento.
El buscador quedará corriendo en segundo plano esperando un atajo de teclado, para luego desplegar la caja de texto Donde irá nuestra búsqueda. Al dar enter,  se abrirá nuestro navegador predeterminado, con la web en cuestión, la búsqueda y resultados, si los hay.
